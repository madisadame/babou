...
import { useQuizResults, type QuestionOutcome } from '@/hooks/use-quiz-results';
...
export default function QuizScreen() {
  ...
  // Traduit un texte de contenu dans la langue courante (repli français).
        ...
        <SafeAreaView style={styles.safeArea}>
          ...
          <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
            ...
            <ThemedView type="backgroundElement" style={styles.summary}>
              ...
              <ThemedText themeColor="textSecondary">{t('quiz.resultsRate', { pct: rate })}</ThemedText>
            ...
            <Pressable onPress={() => router.back()} hitSlop={Spacing.two} style={styles.secondary}>
              <ThemedText type="link" themeColor="textSecondary">
  ...
  const selectChoice = (choiceId: string) => {
    // En mode immédiat, la réponse se verrouille une fois donnée.
    if (revealed) return;
